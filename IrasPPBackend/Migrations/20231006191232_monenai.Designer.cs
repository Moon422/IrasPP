...
namespace IrasPPBackend.Migrations
{
    ...
    [Migration("20231006191232_monenai")]
    partial class monenai
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IrasPPBackend.Models.Auth", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("IrasPPBackend.Models.User", b =>
                {
                    b.HasOne("IrasPPBackend.Models.Auth", "Auth")
                        .WithOne("User")
                        .HasForeignKey("IrasPPBackend.Models.User", "AuthId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
